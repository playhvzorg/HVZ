...
namespace HVZ.Web.Data
{
    ...
    public class DiscordAccountController : ControllerBase
    {
        ...
        public DiscordAccountController(IDataProtectionProvider provider, DiscordIntegrationSettings settings,
            UserManager<ApplicationUser> userManager, WebConfig webConfig, SignInManager<ApplicationUser> signInManager)
        {
            Provider = provider;
        ...
        public IActionResult Login()
        {
            ...
            return Redirect(
                $"https://discord.com/api/oauth2/authorize?client_id={DiscordSettings.ClientId!}&redirect_uri={redirectUri}&response_type=code&scope=identify");
        }
            ...
            using (var client = new HttpClient())
            {
                ...
                if (code is null)
                    throw new InvalidOperationException(
                        "Error getting code property. Make sure you are starting at discord/login and discord will provide the code");
